package com.tantawy.warbabankpoc.data.remote.interceptors

import com.google.gson.JsonObject
import com.google.gson.JsonParser
import com.tantawy.warbabankpoc.data.exceptions.APIException
import com.tantawy.warbabankpoc.data.exceptions.NetworkException
...
class ErrorHandlerInterceptor(private val stringsRepository: StringsRepository) : Interceptor {
    ...
    private val successStatus = true
        ...
        if (isJsonTypeResponse(body)) {
            ...
            try {
                ...
                if (obj is JsonObject && obj.has(keyStatus)) {
                    status = obj.get(keyStatus).asBoolean
                }
            ...
            throw APIException(
                ...
                stringsRepository.getUnknownErrorMessage()
            )
        }
